...
SET @path = 'C:\Users\netcore\Desktop\IndusInd\stats\log\'
...
WHILE @maxpk >= @ctr_1
    ...
    BEGIN 
            ...
            Insert into  GupShup_Promo_Outgoing_SMS_nc_dlr (MESSAGE_ID,TRANSACTIONID, MOBILE_NUMBER, 
            SENDER, MESSAGE_TEXT, SENT_TIME, SENT_STATUS, DELIVERY_STATUS, DELIVERY_TIME, ERROR_CODE, 
            ERROR_DESC, PRIORITY, ChannelId)
            
            Select mst.MESSAGE_ID,mst.TRANSACTIONID, mst.MOBILE_NUMBER, 
            mst.SENDER, mst.MESSAGE_TEXT, mst.SENT_TIME, mst.SENT_STATUS, 
            tmp.DELIVERY_STATUS, tmp.DELIVERY_TIME, 
            mst.ERROR_CODE, mst.ERROR_DESC, mst.PRIORITY, mst.ChannelId 
            ...
            Insert into   Netcore_Promo_Outgoing_SMS_nc_dlr (MESSAGE_ID,TRANSACTIONID, MOBILE_NUMBER, 
            SENDER, MESSAGE_TEXT, SENT_TIME, SENT_STATUS, DELIVERY_STATUS, DELIVERY_TIME, ERROR_CODE, 
            ERROR_DESC, PRIORITY, ChannelId)
            
            Select mst.MESSAGE_ID,mst.TRANSACTIONID, mst.MOBILE_NUMBER, 
            mst.SENDER, mst.MESSAGE_TEXT, mst.SENT_TIME, mst.SENT_STATUS, tmp.DELIVERY_STATUS, tmp.DELIVERY_TIME, 
            mst.ERROR_CODE, mst.ERROR_DESC, mst.PRIORITY, mst.ChannelId 
            ...
            Insert into Netcore_Promo_Outgoing_SMS_NOV_2016_nc_dlr (MESSAGE_ID,TRANSACTIONID, MOBILE_NUMBER, 
            SENDER, MESSAGE_TEXT, SENT_TIME, SENT_STATUS, DELIVERY_STATUS, DELIVERY_TIME, ERROR_CODE, 
            ERROR_DESC, PRIORITY, ChannelId)
